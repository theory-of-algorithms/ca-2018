...
Note that ``from scratch'' means using only \mintinline{racket}{cons}, \mintinline{racket}{car}, \mintinline{racket}{cdr}, \mintinline{racket}{define}, \mintinline{racket}{lambda}, \mintinline{racket}{if}, \mintinline{racket}{null}, \mintinline{racket}{null?}, \mintinline{racket}{cond}, \mintinline{racket}{=} and the basic numerical operators (\mintinline{racket}{+}, \mintinline{racket}{-}, \mintinline{racket}{*}, \mintinline{racket}{/}, \mintinline{racket}{modulo}).
